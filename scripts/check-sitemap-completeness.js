...
// Repo-local override: URL prefixes this check should never evaluate,
// because this repo's sitemap.njk includes/excludes these pages via its own
// bespoke logic (here: `not dataset.experimental`, a per-item data field in
// _data/datasets.js) rather than Eleventy's collections/frontmatter-flag
// system this script is built around. Empty in every other repo's copy.
const LOCAL_IGNORE_PREFIXES = ['/datasets/'];
